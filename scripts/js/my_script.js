$( document ).ready(function() {
	...
	$("#home").click(function() {
		$('#info').html("<h2 class='red animate_2'>Привет Всем!</h2><h4 class='animate_1'>Приветствую вас на своем сайте-визитке.</h4><h4 class='animate_1'>Можете посмотреть на мои работы или связаться со мной.</h4><h4 class='animate_1'>*Страничка очень старая - на подходе обновленная:)</h4>");
	});
	$("#porfolio").click(function() {
